...
def video(args):
    ...
    # Multiprocessing: Init input and output Queue, output Priority Queue and
    # pool of workers
        ...
        while True:
            ...
            if not input_q.full():
                ...
                if ret:
                    ...
                    if firstReadFrame:
                        print(
                            " --> Reading first frames from input file. Feeding input queue.\n")
            ...
            if not output_pq.empty():
                ...
                if prior > countWriteFrame:
                    ...
                    if firstUsedFrame:
                        print(
                            " --> Start using recovered frame (displaying and/or writing).\n")
